...
//--- Read the ADC result and write to IPC channel 1
	...
	IpcRegs.IPCSENDDATA = (Uint32) AdcResult;       // Write the result to the IPC data register
...
//--- Read IPC channel 0 and write to DAC-B
	DacData = (Uint16) IpcRegs.IPCRECVADDR;         // Read data on IPC ADDR register
	DacbRegs.DACVALS.all = DacData;                 // Write to DAC-B
}
